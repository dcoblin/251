...
euro_mpx_cases %>% 
  ...
  theme_minimal() +
  labs(title = "Monthly Cases of Monkeypox in Europe", x = "Month (2022)", 
       y = "Monkeypox Cases") +
...
ggplot(data=graph1, aes(x=floor_month, y=monthly_rate_region, group= EU_region)) +
  ...
  theme_minimal() +
  labs(title = "Rate of Monkeypox Infections", x = "Month (2022)", 
