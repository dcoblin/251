...
Table 4 illustrates the density within each region of the EU by the population density gathered by count for where an individual lives. 
...
Table 5 summarizes the region demographics by age using census data. We can see the age variance from region to region within the EU.
